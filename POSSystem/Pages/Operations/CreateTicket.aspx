...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="border p-3">
        ...
        <div class="border p-3 mb-3">
            ...
            <div class="row">
                <div class="col-md-4">
                    <ul id="list_assigned" class="list-unstyled mb-2">
        ...
        <div class="border p-3 mb-3">
            ...
            <div class="row">
                <div class="col-md-4">
                    <ul id="list_concerned" class="list-unstyled mb-2">
                        <li>Building Maintanance Ticket</li>
                        <li>Machinary Maintanance Ticket</li>
                        <li>ERP Ticket</li>
                        <li>Product Related Ticket</li>
        ...
        <div class="border p-3 mb-3">
            ...
            <div class="row">
                <div class="col-md-4">
                    <ul id="list_performer" class="list-unstyled mb-2">
                        <li>Building Maintanance Ticket</li>
                        <li>Machinary Maintanance Ticket</li>
                        <li>ERP Ticket</li>
                        <li>Product Related Ticket</li>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-6">
                <div class="border p-3 me-md-2">
                    ...
                    <ul id="list_tickettype" class="list-unstyled mb-2">
                        <li>Building Maintanance Ticket</li>
                        <li>Machinary Maintanance Ticket</li>
                        <li>ERP Ticket</li>
                        <li>Product Related Ticket</li>
            ...
            <div class="col-md-6">
                <div class="border p-3 ms-md-2">
                    ...
                    <ul id="list_ticketresponse" class="list-unstyled mb-2">
