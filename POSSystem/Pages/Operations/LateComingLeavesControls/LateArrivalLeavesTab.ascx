<%@ Control Language="VB" AutoEventWireup="true" CodeBehind="LateArrivalLeavesTab.ascx.vb" Inherits="POSSystem.Pages.Operations.LateComingLeavesControls.LateArrivalLeavesTab" %>

<%-- Record # + Date (top-right) --%>
...
<div class="border p-2 mb-3" style="background-color:#f8f9fa; font-size:0.83rem;">
    ...
    <div class="row g-2 mb-2 align-items-center">
        <div class="col-auto">
            <label class="fw-semibold mb-0" for="txtLlEmpId">Employ ID</label>
        </div>
        <div class="col-auto">
            <input type="text" id="txtLlEmpId" class="form-control form-control-sm rounded-0" style="width:110px;" />
        </div>
        <div class="col-auto ms-2">
            <label class="fw-semibold mb-0">Employ Name</label>
        </div>
        <div class="col-auto">
    ...
    <div class="row g-2 mb-2 align-items-center">
        <div class="col-auto">
            <label class="fw-semibold mb-0" for="txtLlPosition">Position</label>
        </div>
        <div class="col-auto">
            <input type="text" id="txtLlPosition" class="form-control form-control-sm rounded-0" style="width:120px;" />
        </div>
        <div class="col-auto ms-2">
            <label class="fw-semibold mb-0" for="txtLlCompany">Company</label>
        </div>
        <div class="col-auto">
            <input type="text" id="txtLlCompany" class="form-control form-control-sm rounded-0" style="width:100px;" />
        </div>
        <div class="col-auto ms-2">
            <label class="fw-semibold mb-0" for="txtLlLocation">Location</label>
        </div>
        <div class="col">
            <input type="text" id="txtLlLocation" class="form-control form-control-sm rounded-0" />
        </div>
    </div>

    <div class="row g-2 align-items-center">
        <div class="col-auto">
            <label class="fw-semibold mb-0" for="txtLlDivision">Division</label>
        </div>
        <div class="col-auto">
            <input type="text" id="txtLlDivision" class="form-control form-control-sm rounded-0" style="width:100px;" />
        </div>
        <div class="col-auto ms-2">
            <label class="fw-semibold mb-0" for="txtLlDept">Department</label>
        </div>
        <div class="col-auto">
            <input type="text" id="txtLlDept" class="form-control form-control-sm rounded-0" style="width:120px;" />
        </div>
        <div class="col-auto ms-2">
            <label class="fw-semibold mb-0" for="txtLlEmpStart">Employment Starting Date</label>
        </div>
        <div class="col-auto">
            <input type="text" id="txtLlEmpStart" class="form-control form-control-sm rounded-0" style="width:120px;" placeholder="MM/DD/YYYY" />
        </div>
    </div>
...
<div class="border p-2 mb-2" style="font-size:0.83rem;">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div class="d-flex align-items-center gap-1">
            ...
            <div class="form-check form-check-inline mb-0">
                <input class="form-check-input" type="radio" name="radLlReport" id="radLlSickLeave" checked />
...
<div class="border p-2 mb-2" style="font-size:0.83rem;">
    ...
    <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
        <div class="form-check mb-0" style="min-width:160px;">
            <input class="form-check-input" type="radio" name="radLlLeave" id="radLlAnnual" checked />
...
<div class="border p-2 mb-2" style="font-size:0.83rem;">
    ...
    <div class="d-flex align-items-center gap-3 flex-wrap">
        ...
        <div class="form-check form-check-inline mb-0">
            <input class="form-check-input" type="radio" name="radLlApproval" id="radLlDisapproved" checked />
...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-2" style="font-size:0.83rem;">
    <div class="d-flex align-items-center gap-3 flex-wrap">
        ...
        <div class="form-check form-check-inline mb-0">
            <input class="form-check-input" type="radio" name="radLlSystem" id="radLlSysDisapproved" checked />
